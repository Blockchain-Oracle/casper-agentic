    ...
    <div className="min-h-dvh bg-surface text-ink">
      ...
      <main className="mx-auto max-w-2xl px-5 py-12">
        ...
        <p className="mt-2 max-w-lg text-[15px] leading-relaxed text-ink-2">
          Point the gateway at an MCP server or an OpenAPI spec. It discovers the tools; you price each
          one in WCSPR and publish a paid x402 endpoint that agents can call with an API key.
        </p>
        <div className="mt-8">
          <RegisterFlow />
        </div>
